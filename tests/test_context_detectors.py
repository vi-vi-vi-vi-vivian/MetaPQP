...
def test_product_landing_is_not_misclassified_by_unsubscribe_copy():
    snapshot = PageSnapshot(
        page_id="subscription-service",
        requested_url="https://portal.example.test/product/subscription.html",
        final_url="https://portal.example.test/product/subscription.html",
...
def test_console_subscription_page_has_purchase_stage_and_features():
    snapshot = PageSnapshot(
        page_id="purchase",
        requested_url="https://console.example.test/subscriptions/",
        final_url="https://console.example.test/subscriptions/",
        title="Subscription Console",
        body_text=(
                "Subscribe to a service for Efficient Development. "
